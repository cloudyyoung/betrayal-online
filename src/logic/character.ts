...
export interface PlayableCharacter extends Character {
    ...
    defaultMightIndex: keyof CharacterTraitScale;
    speed: CharacterTraitScale;
    defaultSpeedIndex: keyof CharacterTraitScale;
    sanity: CharacterTraitScale;
    defaultSanityIndex: keyof CharacterTraitScale;
    knowledge: CharacterTraitScale;
    defaultKnowledgeIndex: keyof CharacterTraitScale;
}
